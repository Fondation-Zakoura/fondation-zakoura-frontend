...
import { useAddBudgetLineMutation, useGetBudgetLineOptionsQuery } from '@/features/api/budgetLineApi';
...
function AddBudgetLineModal({ onClose, refetch }: Props) {
        ...
        <form onSubmit={handleAdd} className="space-y-4">
            ...
            <div className="flex flex-col gap-1">
             ...
             <Select value={form.project_id} onValueChange={(e) => {
               ...
               <SelectTrigger className={`w-full ${errors.project_id ? 'border-red-500' : ''}`} id='project_id' name='project_id'>
                <SelectValue placeholder="Le Projet Concerne" />
               </SelectTrigger>
               <SelectContent>
          ...
          <DialogFooter>
            <Button type="submit" className="text-white" disabled={addLoading}>
              {addLoading && <span className="loader mr-2"></span>} Ajouter
            </Button>
            <DialogClose asChild>
