...
import type { FetchBaseQueryError } from "@reduxjs/toolkit/query"; // Corrected import for error type
...
export const StructurePartnersListPage: React.FC = () => {
  ...
  const handleSaveStructure = useCallback(async (name: string, id?: number) => {
    ...
    mutationPromise.unwrap()
      ...
      .catch((error: FetchBaseQueryError) => { // Explicitly type error as FetchBaseQueryError
