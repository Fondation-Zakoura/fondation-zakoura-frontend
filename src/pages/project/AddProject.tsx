...
const AddProject: React.FC = () => {
  ...
  const handlePartnerSelectChange = (
    idx: number,
    name: string,
    value: string
  ) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        project_bank_account_id: form.bank_account_id
        ...
        <Card className="p-8">
          ...
          <div className="bg-white rounded-xl grid grid-cols-1 md:grid-cols-2 gap-4 shadow p-6 mb-4">
            ...
            <div>
              ...
              {errors.responsible_id && touched.responsible_id && (
                <div className="text-red-500 text-xs mt-1">
          ...
          <div className="bg-white rounded-xl shadow p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <div className="w-full" ref={inputRefs.project_nature}>
                  <Select
                    ...
                    onValueChange={(val) =>
                      handleSelectChange("project_nature", val)
                    }
                  >
                  ...
                  {errors.project_nature && touched.project_nature && (
                    <div className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                <div className="w-full">
                  <Combobox
                    ...
                    onChange={(val) =>
                      handleSelectChange("project_type_id", val)
                    }
                    placeholder="Sélectionner le type"
                    disabled={optionsLoading}
                  />
                </div>
                {errors.project_type_id && touched.project_type_id && (
                  <div className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                <div className="w-full">
                  <Combobox
                    ...
                    onChange={(val) =>
                      handleSelectChange("project_status_id", val)
                    }
                    placeholder="Sélectionner le statut"
                    disabled={optionsLoading}
                  />
                </div>
                {errors.project_status_id && touched.project_status_id && (
                  <div className="text-red-500 text-xs mt-1">
              ...
              <div>
                ...
                {errors.actual_start_date && touched.actual_start_date && (
                  <div className="text-red-500 text-xs mt-1">
                    ...
                    <div className="flex-1 flex flex-col md:flex-row gap-4">
                      <div className="flex-1">
                        ...
                        <Combobox
                          ...
                          onChange={(value) =>
                            handlePartnerSelectChange(idx, "partner_id", value)
                          }
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent>
          ...
          <DialogFooter className="flex justify-end gap-4">
            <Button variant="outline" onClick={handleModalCancel} type="button">
              Annuler
            </Button>
            <Button
