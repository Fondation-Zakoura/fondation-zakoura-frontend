    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex items-center justify-center gap-2">
          <Button variant="ghost" className="p-2 rounded hover:bg-gray-200 text-gray-600" size="icon" onClick={e => { e.stopPropagation(); handleShow(row.id); }}>
            <Eye size={16}/>
          </Button>
          <Button variant="ghost" className="p-2 rounded hover:bg-blue-100 text-blue-600" size="icon" onClick={e => { e.stopPropagation(); navigate(`/projects/${row.id}/edit`) }}>
            <Pen size={16} />
          </Button>
          <Button variant="ghost" className="p-2 rounded hover:bg-red-100 text-red-600" size="icon" onClick={e => { e.stopPropagation(); handleDelete(row.id); }}>
            <Trash size={16}/>
          </Button>
        </div>
      ),
    ...
    <>
      ...
      <Dialog open={bulkDeleteModalOpen} onOpenChange={setBulkDeleteModalOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant={'destructive'} onClick={() => setBulkDeleteModalOpen(false)}>Fermer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
