...
const ShowProject: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'Créé le', value: project.created_at ? new Date(project.created_at).toLocaleDateString() : '-' },
  ];  
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="mb-3">
                    ...
                    <Badge variant={'outline'}>{project.project_status?.name || '-'}</Badge>
                  </div>
                  <div className="mb-3">
                  ...
                  <div className="mb-3">
                    ...
                    <p className="font-semibold text-gray-700">{project.total_budget ? `${project.total_budget} MAD` : '-'}</p>
                  </div>
                  <div className="mb-3">
                  ...
                  {project.project_bank_account ? (
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <span className="font-semibold text-gray-800 text-sm">{project.project_bank_account.agency || '-'}</span>
                      </div>
                      <div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <span className="font-semibold text-gray-800 text-sm">{project.zakoura_contribution ? `${project.zakoura_contribution} MAD` : '-'}</span>
                    </div>
                    <div>
                      <span className="block text-xs text-gray-400">Responsable</span>
                      <span className="font-semibold text-gray-800 text-sm">{project.responsible?.name || '-'}</span>
                      <span className="block text-xs text-gray-500">{project.responsible?.email || ''}</span>
                    </div>
                    <div>
